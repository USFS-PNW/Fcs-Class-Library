...
namespace FcsClassLibrary {
  ...
  public class FCS_GET_VOLCSGRS : Devart.Data.Oracle.OraclePackage {
    ...
    public FCS_GET_VOLCSGRS() {
      base.PackageName = "FCS.FCS_GET_VOLCSGRS";
    }
